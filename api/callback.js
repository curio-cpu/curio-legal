export default async function handler(req, res) {
  ...
  try {
    // Échange du code OAuth contre les tokens TikTok
    ...
    // Enregistrement / mise à jour du token dans Supabase
    ...
    return res.status(200).send(`
      ...
      >
        ...
        <p>
          Le compte TikTok est maintenant enregistré
          de manière sécurisée.
        </p>

        <p>
          Les autorisations TikTok ont été mises à jour.
        </p>
      </body>
      </html>
    `);
